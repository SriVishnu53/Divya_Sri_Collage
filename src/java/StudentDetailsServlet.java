    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (studentId != null) {
            ...
            try {
                ...
                String studentName = "", fatherName = "", dob = "", gender = "", address = "", phoneNo = "", email = "",
                ...
                response.getWriter().println("<title>Student Details - Divya Sri College Of Arts & Science</title>");
                ...
                response.getWriter().println("<nav><ul><li><a href='student.jsp'>Back</a></li></ul></nav>");
                response.getWriter().println("</header>");
                ...
                if (photoStream != null) {
                    ...
                    response.getWriter().println("<img src='data:image/jpeg;base64," + encodeImage(photoStream) + "' alt='Student Photo' style='width: 100%; height: 400px; object-fit: cover;'>");
                }
                response.getWriter().println("</div>");

                // Content Section (student details in table format)
                response.getWriter().println("<table>");
                response.getWriter().println("<tr><th>Field</th><th>Details</th></tr>");
                response.getWriter().println("<tr><td>Name</td><td>" + studentName + "</td></tr>");
                response.getWriter().println("<tr><td>Father's Name</td><td>" + fatherName + "</td></tr>");
                ...
                response.getWriter().println("<tr><td>Phone</td><td>" + phoneNo + "</td></tr>");
                response.getWriter().println("<tr><td>Email</td><td>" + email + "</td></tr>");
                response.getWriter().println("<tr><td>Course</td><td>" + course + "</td></tr>");
