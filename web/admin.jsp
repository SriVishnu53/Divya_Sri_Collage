...
<body>
    ...
    <div class="sub-header">
        <div class="box">
    <a href="AdminDetailsServlet">Admin Details</a>
</div>
        <div class="box">
            <a href="addstaff.html">Add_Staff</a>
        </div>
        <div class="box">
            <a href="removestaff.html">Remove_Staff</a>
        </div>
        <div class="box">
            <a href="addstudent.html">Add_Student</a>
        </div>
        <div class="box">
            <a href="removestudent.html">Remove_Student</a>
        </div>
        <div class="box">
            <a href="annonucment.html">Announcement</a>
        </div>
    </div>
...
<div class="admin-id">
        Logged in as: <%= session.getAttribute("adminid") %>
    </div>
    <footer>
